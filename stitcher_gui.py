...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 11:08:30 2020
...
# Try to make sure ffmpeg is installed
check_req_installs()
...
if arg_input_folder is None:
    input_file_paths_list = gui_file_select_many(video_search_directory, window_title = "Select video files")
